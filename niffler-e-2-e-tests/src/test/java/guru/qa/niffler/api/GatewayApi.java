...
public interface GatewayApi {
  ...
  @GET("api/friends/all")
  Call<List<UserDataJson>> allFriends(@Header("Authorization") String bearerToken,
  ...
  Call<UserDataJson> sendInvitation(@Header("Authorization") String bearerToken,
                                    @Body FriendJson friend);

  @POST("api/invitations/accept")
  Call<UserDataJson> acceptInvitation(@Header("Authorization") String bearerToken,
                                      @Body FriendJson friend);

  @POST("api/invitations/decline")
  Call<UserDataJson> declineInvitation(@Header("Authorization") String bearerToken,
                                       @Body FriendJson friend);
  ...
  Call<UserDataJson> currentUser(@Header("Authorization") String bearerToken);

  @GET("api/users/all")
  Call<List<UserDataJson>> allUsers(@Header("Authorization") String bearerToken,
                                    @Query("searchQuery") @Nullable String searchQuery);

  @POST("api/users/update")
  Call<UserDataJson> updateUser(@Header("Authorization") String bearerToken,
                                @Body UserDataJson user);
}
