...
public class UsersQueueExtension implements
  ...
  static {
    EMPTY_USERS.add(new StaticUser("test1", "12345", null, null, null));
    WITH_FRIEND_USERS.add(new StaticUser("duck", "12345", "aamihailov", null, null));
    WITH_INCOME_REQUEST_USERS.add(new StaticUser("mrx", "12345", null, "aamihailov", null));
    WITH_OUTCOME_REQUEST_USERS.add(new StaticUser("aamihailov", "12345", "duck", null, "mrx"));
  }
  ...
  public StaticUser resolveParameter(ParameterContext parameterContext, ExtensionContext extensionContext) throws ParameterResolutionException {
    return ((Map<UserType, StaticUser>) extensionContext.getStore(NAMESPACE)
        ...
        .get(AnnotationSupport.findAnnotation(
