...
public class UserdataUserEntity implements Serializable {
  ...
  public UserdataUserEntity(UUID id) {
    this.id = id;
  }

  public UserdataUserEntity(String username, CurrencyValues currency) {
  ...
  @Nonnull
  public static UserdataUserEntity fromJson(@Nonnull UserDataJson json) {
    ...
    ue.setPhoto(json.photo() != null ? json.photo() : null);
    ue.setPhotoSmall(json.photoSmall() != null ? json.photoSmall() : null);
    return ue;
  }
